                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-12 rounded" style={{ background: "linear-gradient(49deg, rgb(44 163 214 / 7%) 0%, rgb(105 25 226 / 12%) 100%)", boxShadow: "10px 10px 80px -17px rgba(0,0,0,0.25)" }}>
                    <div className="p-4 m-3">
                        <div className="text-center">
                            ...
                            <h4 className="text-dark font-weight-normal">Welcome to <span className="font-weight-bold">Yentric</span></h4>
                        ...
                        <form method="POST" action="#" className="needs-validation" noValidate>
                            ...
                            <div className="form-group">
                                <div className="form-check">
                                    <input className="form-check-input" name="remember" type="checkbox" id="remember-me" />
                                    <label className="form-check-label" htmlFor="remember-me">Remember Me</label>
                                </div>
                            </div>

                            <div className="form-group text-end">
                                <a href="auth-forgot-password.html" className="float-start mt-3">
                                    Forgot Password?
                                </a>
